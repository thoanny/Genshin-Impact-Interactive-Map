...
//	L.marker([ 100, 150], {icon: Credits, title: "Crédits et Remerciements"}).addTo(mymap).bindPopup('<p><h4>Crédits et Remerciements</h4></p><p align="center"><h3>Conception :</h3></p><p align="center">TMKFrench</p><h3>Screenshots et Vidéos :</h3><p align="center">TMKFrench<br>ManqueDeBol<br>AstamoranVoz<br>Tumay<br>SupremB4N4N4</p><h3>Contributeurs et Aide :</h3><p align="center">Ackile<br>Larolina<br>Conan<br>kerthe17</p>', popupOptions);
        ...
        // L.marker([ 400,1943], {icon: Null, title: ""}).addTo(mymap).bindPopup('<h4><img src="/media/logo.jpg"/><br>TMKFrench - LGDC</h4><h3>Bienvenue sur notre Map interactive !</h3><p>Cliquez sur une icône de votre choix<br>pour plus d\'information.<br>Utilisez la molette de la souris pour zoomer<br>et le menu pour afficher ou masquer les POIs.<br><a style="color:red;">Nombre de Marker : 319</a><br><br><strong><a title="Notre Discord" href="https://discord.gg/u4hNRzK" target="_blank">Rejoignez-nous sur notre Discord</a></strong><br>Pour jouer avec nous ou discuter tout simplement.<br>PENSEZ A DEMANDER DES DROITS AU ADMINS OU MODERATEUR</p><p style="color : red;">La map est en cours de création, nous rajoutons<br>les marqueurs au fur et à mesure.<br>Si vous trouvez de nouveaux emplacements<br>non référencés, vous pouvez me contacter en MP sur discord : TMKFrench#4221<br>ou par mail à infomap@tmkfrench.fr', {'minWidth': '640px','minHeight': '480px'}).openPopup();
        L.marker([  60,1943], {icon: Null, title: ""}).addTo(mymap).bindPopup('<h4><img src="/media/logo.jpg"/><br>TMKFrench - LGDC</h4><h3>NEW !!! All Panorama / Viewpoint<br>Bienvenue sur notre Map interactive !</h3><p>Cliquez sur une icône de votre choix pour plus d\'info.<br>Utilisez la molette de la souris pour zoomer<br>et le menu pour afficher ou masquer les POIs.<br><a style="color:red;">Nombre de Marker : ' + nbtmark + '</a><br><br><a style="color : red;"><strong>Release V3.5 du 11/11/2020</strong></a><br>Rajout des marqueurs pour les matériaux de farm<br>Passage au Stockage local à la place des cookies<br>Mise en ligne de la map de Liyue.<br><br><u><strong>Site Partenaire :</strong></u><br><a title="Next-Stage.fr" href="https://www.next-stage.fr/" target="_blank"><img src="/media/nextstage.png" alt="Next-Stage.fr" width="158" height="36" /></a><br><br>Si vous voulez participer en m\'envoyant de nouveaux<br>emplacements, n\'hésitez pas à me contacter<br>par mail à infomap@tmkfrench.fr ou par<br>MP sur discord : TMKFrench#4221', {'minWidth': '640px','minHeight': '480px'}).openPopup();
